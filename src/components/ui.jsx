...
function Icon({ name, size = 20, color = 'currentColor', stroke = 1.7, style }) {
  ...
  const paths = {
    ...
    star:     <path d="M12 3.5l2.6 5.3 5.9.9-4.3 4.2 1 5.9-5.2-2.8-5.2 2.8 1-5.9-4.3-4.2 5.9-.9z" {...p}/>,
    starFill: <path d="M12 3.5l2.6 5.3 5.9.9-4.3 4.2 1 5.9-5.2-2.8-5.2 2.8 1-5.9-4.3-4.2 5.9-.9z" fill={color} stroke="none"/>,
