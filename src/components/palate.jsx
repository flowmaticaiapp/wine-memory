    ...
    <div style={{ height:'100%', overflow:'auto', background:'#fff' }}>
      ...
      <div style={{ padding:'8px 18px', paddingBottom:V_NAV+96 }}>
        ...
        <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', gap:12 }}>
          ...
          {onSignOut && <button onClick={onSignOut} style={{ flexShrink:0, marginTop:4, display:'inline-flex', alignItems:'center', gap:6, background:'#fff', border:`1px solid ${T.line2}`, borderRadius:99, padding:'7px 13px', cursor:'pointer', fontFamily:'var(--sans)', fontSize:12.5, fontWeight:600, color:T.ink2 }}><Icon name="lock" size={14} color={T.ink2}/> Sign out</button>}
        </div>
        {email && <div style={{ marginTop:6, fontFamily:'var(--mono)', fontSize:11, color:T.ink4 }}>Signed in as {email}</div>}
