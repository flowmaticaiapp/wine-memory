...
const DISH_RULES = [
  ...
  { re:/\bpork\b[^.]*\btacos?\b|\btacos?\b[^.]*\bpork\b|\bcarnitas\b|\bal pastor\b/i,
    id:'pork-tacos', dish:'pork tacos',
    primary:{ grape:'Dry Rosé', why:'A fuller dry rosé has enough body for the pork, freshness for its richness, and generous fruit that handles chile, lime and salsa without adding harsh tannin.', deeperTitle:'Tavel, Bandol rosé or sparkling Brut Rosé', deeper:'A structured southern French rosé meets the pork without overpowering the toppings; sparkling Brut Rosé adds bubbles that refresh between rich, spicy bites.', lookFor:["Tavel or Bandol for a fuller, savoury dry rosé", "Sparkling Brut Rosé or Crémant d’Alsace for bubbles and fruit", "If the salsa is hot, an off-dry Riesling keeps the heat in check"], matchGrapes:['Grenache','Tempranillo','Riesling'] },
