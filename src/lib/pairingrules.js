...
const DISH_RULES = [
  ...
  { re:/\bpork\b[^.]*\btacos?\b|\btacos?\b[^.]*\bpork\b|\bcarnitas\b|\bal pastor\b/i,
    id:'pork-tacos', dish:'Mexican pork tacos',
    primary:{ grape:'Dry Rosé', why:'The Mexican taco preparation matters as much as the pork: a fuller dry rosé has enough body for the meat, freshness for its richness, and generous fruit for chile, salsa, lime, cilantro and corn tortilla without adding harsh tannin.', deeperTitle:'Tavel, Bandol rosé or sparkling Brut Rosé', deeper:'A structured southern French rosé meets carnitas or al pastor without overpowering the salsa and toppings; sparkling Brut Rosé adds bubbles that refresh between rich, spicy bites.', lookFor:["Tavel or Bandol for a fuller, savoury dry rosé", "Sparkling Brut Rosé or Crémant d’Alsace for bubbles and fruit", "If the salsa is hot, an off-dry Riesling keeps the heat in check"], matchGrapes:['Grenache','Tempranillo','Riesling'] },
    others:[ {direction:'Bubbly and refreshing', grape:'Sparkling Brut Rosé', why:'Bubbles cut the pork’s richness while red-fruit flavours suit chile and salsa.'}, {direction:'Softer for more heat', grape:'Off-dry Riesling', why:'A touch of sweetness cools a hotter salsa while acidity keeps the pairing lively.'} ], avoidNote:'High alcohol, heavy oak and firm tannin make chile heat feel hotter and can overwhelm fresh taco toppings.', avoid:['Cabernet Sauvignon','Nebbiolo'] },

  { re:/(fish|shrimp|prawn|seafood)[^.]*\btacos?\b|\btacos?\b[^.]*(fish|shrimp|prawn|seafood)/i,
    id:'fish-tacos', dish:'Mexican fish tacos',
    primary:{ grape:'Albariño', why:'Fish tacos need a wine for the whole bite: Albariño brings citrusy acidity for lime and salsa, saline freshness for the fish, and enough fruit for cabbage, crema and mild chile.', deeperTitle:'Albariño from Rías Baixas', deeper:'This coastal Spanish white is crisp, citrusy and lightly saline — refreshing with fried or grilled fish while staying lively beside Mexican toppings.', lookFor:["Rías Baixas on the label for classic Albariño", "Txakoli for an even lighter, sharper alternative", "Choose a dry, unoaked white with bright citrus acidity"], matchGrapes:['Albariño','Sauvignon Blanc','Verdejo'] },
    others:[ {direction:'Leaner and sharper', grape:'Txakoli', why:'Brisk acidity and a slight spritz refresh fried fish and lime.'}, {direction:'Herbal and familiar', grape:'Sauvignon Blanc', why:'Citrus and green notes suit cilantro, cabbage and salsa verde.'} ], avoidNote:'Heavy oak and firm tannin overwhelm the fish and can taste harsh beside chile.', avoid:['Cabernet Sauvignon','Nebbiolo'] },

  { re:/(beef|steak|bistec|carne asada)[^.]*\btacos?\b|\btacos?\b[^.]*(beef|steak|bistec|carne asada)/i,
    id:'beef-tacos', dish:'Mexican beef tacos',
    primary:{ grape:'Tempranillo', why:'Tempranillo has enough savoury fruit for charred beef, but its fresher acidity and moderate tannin stay friendly with salsa, lime, onion and corn tortilla.', deeperTitle:'Rioja Crianza or a fresher Spanish Tempranillo', deeper:'The red fruit and savoury spice echo grilled carne asada without turning the taco into a heavy steak pairing.', lookFor:["Rioja Crianza for red fruit and restrained oak", "Garnacha for a juicier, softer red", "Keep alcohol and tannin moderate when the salsa is hot"], matchGrapes:['Tempranillo','Grenache','Garnacha','Malbec'] },
    others:[ {direction:'Juicier and softer', grape:'Garnacha', why:'Ripe red fruit handles chile while softer tannin leaves the toppings fresh.'}, {direction:'Bolder for more char', grape:'Malbec', why:'Works when grilled beef leads, provided the salsa is not very hot.'} ], avoidNote:'Very tannic, high-alcohol reds amplify chile heat and bury fresh toppings.', avoid:['Nebbiolo'] },

  { re:/\bchicken\b[^.]*\btacos?\b|\btacos?\b[^.]*\bchicken\b/i,
    id:'chicken-tacos', dish:'Mexican chicken tacos',
    primary:{ grape:'Verdejo', why:'Verdejo’s citrusy freshness lifts chicken, lime, cilantro and salsa, while its light herbal character fits the Mexican toppings better than a heavy, oaky white.', deeperTitle:'Spanish Verdejo or Sauvignon Blanc', deeper:'A crisp, unoaked white keeps the whole taco bright; choose the fruitier route when the salsa has more heat.', lookFor:["Rueda on the label for Spanish Verdejo", "Unoaked Sauvignon Blanc for citrus and herbs", "For hotter salsa, choose a fruitier white with moderate alcohol"], matchGrapes:['Verdejo','Sauvignon Blanc','Riesling'] },
    others:[ {direction:'More herbal', grape:'Sauvignon Blanc', why:'Green, citrusy notes mirror cilantro and salsa verde.'}, {direction:'Softer for more heat', grape:'Off-dry Riesling', why:'A little sweetness calms chile without losing freshness.'} ], avoidNote:'Heavy oak and high alcohol make fresh salsa feel dull and chile feel hotter.', avoid:['Cabernet Sauvignon','Nebbiolo'] },

  { re:/(vegetable|veggie|mushroom|bean|cauliflower)[^.]*\btacos?\b|\btacos?\b[^.]*(vegetable|veggie|mushroom|bean|cauliflower)/i,
    id:'vegetable-tacos', dish:'Mexican vegetable tacos',
    primary:{ grape:'Sauvignon Blanc', why:'Bright acidity and herbal lift match lime, cilantro and salsa while respecting vegetables, beans or mushrooms instead of overwhelming them.', deeperTitle:'Sauvignon Blanc, Verdejo or a dry rosé', deeper:'The best choice follows the toppings: herbal whites suit salsa verde, while dry rosé gives roasted vegetables and smoky chile a little more body.', lookFor:["Unoaked Sauvignon Blanc for lime and green herbs", "Rueda Verdejo for a softer, citrusy white", "Dry rosé when roasted vegetables or smoky chile lead"], matchGrapes:['Sauvignon Blanc','Verdejo','Grenache','Gamay'] },
    others:[ {direction:'Rounder and citrusy', grape:'Verdejo', why:'A little more texture for beans or roasted vegetables, with freshness for lime.'}, {direction:'Pink and smoky-friendly', grape:'Dry Rosé', why:'Adds body for roasted fillings without adding firm tannin.'} ], avoidNote:'Heavy oak and firm tannin can flatten vegetables and clash with chile.', avoid:['Cabernet Sauvignon','Nebbiolo'] },

  { re:/\btacos?\b/i,
    id:'mixed-tacos', dish:'a mixed Mexican taco spread',
    primary:{ grape:'Dry Rosé', why:'For mixed or unspecified tacos, dry rosé is the flexible starting point: fresh enough for lime and salsa, fruity enough for chile, and substantial enough for a range of fillings without firm tannin.', deeperTitle:'A fuller dry rosé — Tavel, Bandol or Garnacha rosado', deeper:'This is a table-wide answer, not a guess about the filling. Rosé bridges meat, vegetables, tortilla and toppings while keeping the meal refreshing.', lookFor:["Tavel, Bandol or Spanish Garnacha rosado for more body", "Moderate alcohol and no obvious sweetness unless the salsa is hot", "Sparkling Brut Rosé when you want the most refreshing option"], matchGrapes:['Grenache','Garnacha','Tempranillo','Riesling'] },
    others:[ {direction:'Bubbly and broad', grape:'Sparkling Brut Rosé', why:'Bubbles refresh across rich fillings and spicy toppings.'}, {direction:'Softer for more heat', grape:'Off-dry Riesling', why:'The best table-wide alternative when hot salsa leads.'} ], avoidNote:'High alcohol, heavy oak and firm tannin are the least flexible choices across mixed tacos.', avoid:['Cabernet Sauvignon','Nebbiolo'] },
  ...
  { re:/roast chicken|\bchicken\b|turkey|poultry/i, id:'poultry', dish:'roast chicken',
  ...
  { re:/\bpork\b|pork chop|pork loin|tenderloin|porchetta/i, id:'pork', dish:'pork',
    primary:{ grape:'Pinot Noir', why:'Pinot Noir has enough savoury fruit for pork, bright acidity to refresh its richness, and gentle tannin that will not overwhelm the meat.', deeperTitle:'Cool-climate Pinot Noir or Cru Beaujolais', deeper:'A fresher Pinot Noir or Gamay keeps pork lively; choose the lighter route for chops and the more savoury route for roasted preparations.', lookFor:["Cool-climate Pinot Noir from Oregon, Burgundy or coastal California", "Cru Beaujolais for a juicier, lower-tannin red", "For a white, dry Chenin Blanc brings texture and acidity"], matchGrapes:['Pinot Noir','Gamay','Chenin Blanc'] },
    others:[ {direction:'Juicier and lighter', grape:'Gamay', why:'Low tannin and bright red fruit make it especially easy with pork.'}, {direction:'Textured and white', grape:'Chenin Blanc', why:'Acidity cuts the richness while orchard fruit suits the meat’s sweetness.'} ], avoidNote:'Very tannic reds can make lean pork seem dry.', avoid:['Cabernet Sauvignon','Nebbiolo'] },
...
const TACO_FILLING = /\b(?:pork|carnitas|al pastor|beef|steak|bistec|carne asada|chicken|fish|shrimp|prawn|seafood|vegetable|veggie|mushroom|bean|cauliflower|mixed)\b/i;
const needsTacoGuidance = (q)=> /\btacos?\b/i.test(String(q ?? '')) && !TACO_FILLING.test(String(q ?? ''));
